...
<body>
	...
	<!-- guarantee -->
	<c:if test="${!empty(products)}"><!--products is the model from searchController class-->
			...
			<c:forEach var="product" items="${products}">
				<div class="productContainer">
					...
					<div class="productContainerItem">
						<img id="pic1" src="${product.imagePath}"> <input
							type="text" name="product" value="${product.name}"><br />
